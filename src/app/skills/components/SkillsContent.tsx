...
import { 
    ...
    SiTestinglibrary, SiTypescript, SiRedux, SiPython, SiExpress, SiNodedotjs
} from "react-icons/si";
...
const skills = [
    ...
    { name: 'CSS', icon: SiCss3 }, { name: 'HTML5', icon: SiHtml5 }, { name: 'Node.js', icon: SiNodedotjs }, { name: 'MongoDB', icon: SiMongodb }, 
    { name: 'Supabase', icon: SiSupabase }, { name: 'Prisma', icon: SiPrisma }, { name: 'Pusher', icon: SiPusher }, { name: 'Jest', icon: SiJest }, 
